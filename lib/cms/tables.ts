...
export const TABLE_CONFIGS: TableConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'core_subjects', label: 'Core Subjects', type: 'array', full: true, help: 'One per line' },
      sortOrderField,
      activeField,
    ],
  },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'image_url', label: 'Image URL', type: 'image', full: true },
      { name: 'attachment_url', label: 'Attachment URL (PDF/File)', type: 'text', full: true, help: 'Optional URL for downloading a file' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'internal_marks', label: 'IA/Viva Marks Scored', type: 'number' },
      { name: 'external_marks', label: 'Theory/Practical Marks Scored', type: 'number' },
      { name: 'total_marks', label: 'Total Marks Scored', type: 'number' },
      { name: 'theory_max_marks', label: 'Theory Max Marks', type: 'number' },
      { name: 'theory_min_marks', label: 'Theory Min Marks', type: 'number' },
      { name: 'ia_max_marks', label: 'IA Max Marks', type: 'number' },
      { name: 'ia_min_marks', label: 'IA Min Marks', type: 'number' },
      { name: 'total_min_marks', label: 'Total Min Marks', type: 'number' },
      { name: 'max_marks', label: 'Max Marks', type: 'number' },
      { name: 'grade_points', label: 'Grade Points', type: 'number' },
      { name: 'credit_points', label: 'Credit Points', type: 'number' },
      { name: 'grade', label: 'Grade', type: 'text' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'total_max_marks', label: 'Total Max Marks', type: 'number' },
      { name: 'total_marks_obtained', label: 'Total Marks Obtained', type: 'number' },
      { name: 'percentage', label: 'Percentage', type: 'number' },
      { name: 'overall_result', label: 'Overall Result', type: 'text' },
      { name: 'class_obtained', label: 'Class Obtained', type: 'text' },
      { name: 'programme_total_max_marks', label: 'Programme Total Max Marks', type: 'number' },
      { name: 'programme_total_marks_obtained', label: 'Programme Total Marks Obtained', type: 'number' },
      { name: 'programme_total_credits_obtained', label: 'Programme Total Credits Obtained', type: 'number' },
      { name: 'programme_cgpa', label: 'Programme CGPA', type: 'number' },
      { name: 'programme_grade', label: 'Programme Grade', type: 'text' },
      { name: 'total_marks_words', label: 'Total Marks Words', type: 'text' },
      { name: 'programme_total_marks_words', label: 'Programme Total Marks Words', type: 'text' },
      {
        name: 'result_status',
        label: 'Result Status',
        type: 'select',
  ...
  },
  {
    ...
    slug: 'admission-enquiries',
    label: 'Admission Enquiries',
    singular: 'Admission Enquiry',
    icon: 'FileText',
    titleField: 'name',
    subtitleField: 'phone',
    listFields: ['name', 'email', 'phone', 'level', 'courses', 'percentage', 'status'],
    ...
    fields: [
      ...
      { name: 'percentage', label: 'Marks Obtained (%)', type: 'number', required: true },
      { name: 'queries', label: 'Queries / Notes', type: 'textarea', full: true },
      {
        name: 'status',
        label: 'Status',
        type: 'select',
  ...
  },
  {
    ...
    icon: 'HelpCircle',
    titleField: 'question',
    listFields: ['question', 'sort_order', 'is_active'],
    orderColumn: 'sort_order',
    sortable: true,
    select: '*',
    fields: [
  ...
  },
  {
    ...
    slug: 'alumni-stats',
    label: 'Alumni Stats',
    singular: 'Alumni Stat',
    icon: 'BarChart3',
    titleField: 'label',
    listFields: ['label', 'value', 'sort_order', 'is_active'],
    orderColumn: 'sort_order',
    sortable: true,
    select: '*',
    fields: [
      { name: 'label', label: 'Label', type: 'text', required: true, full: true },
  ...
  },
  {
    table: 'alumni_ways',
    slug: 'alumni-ways',
    label: 'Alumni Engagement Ways',
    singular: 'Engagement Way',
    icon: 'Heart',
    titleField: 'title',
    listFields: ['title', 'icon', 'sort_order', 'is_active'],
    orderColumn: 'sort_order',
    sortable: true,
    select: '*',
    fields: [
      ...
      { name: 'icon', label: 'Icon (lucide name)', type: 'text', required: true, help: 'e.g. Globe, Heart, Award, Briefcase, Calendar, Users' },
      sortOrderField,
      activeField,
    ],
  },
  {
    ...
    listFields: ['admin_name', 'admin_role', 'action', 'target_table', 'details', 'created_at'],
    orderColumn: 'created_at',
    sortable: false,
    select: '*',
    fields: [
      { name: 'admin_name', label: 'Admin Name', type: 'text', required: true },
      { name: 'admin_role', label: 'Admin Role', type: 'text', required: true },
      { name: 'action', label: 'Action', type: 'text', required: true },
      { name: 'target_table', label: 'Target Table', type: 'text', required: true },
