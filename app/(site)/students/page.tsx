        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeUp}>
              ...
              <h2 className="font-display text-4xl md:text-5xl font-bold mt-3 mb-6">Key Dates 2025</h2>
              <p className="text-slate-400 text-lg leading-relaxed">
                Never miss an important deadline. Here are the major academic and co-curricular dates for the 2025–26 year.
              </p>
            </motion.div>
