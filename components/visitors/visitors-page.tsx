...
const directions = [
  { mode: Car, label: 'By Car', desc: 'From Bengaluru city center, take the Jayanagar 7th Block Road. Parking is available at the South Gate entrance (Entry from 2nd Main Road).' },
  { mode: Bus, label: 'By BMTC Bus', desc: 'Take buses from Majestic. Alight at "National College Stop" near 36th B Cross, Jayanagar. 2-minute walk to main gate.' },
  ...
  return (
    <div className="bg-white text-academic-950">
      ...
      <section className="relative pt-44 md:pt-52 pb-16 overflow-hidden">
        ...
        <div className="relative container-wide text-white text-center w-full">
              ...
              <div className="rounded-3xl overflow-hidden shadow-xl border border-slate-200">
                ...
                <div className="bg-white p-6 space-y-4">
                  <div>
                    ...
                    <p className="text-slate-700">National College (Autonomous), <br />No. 36th B Cross, 2nd Main Road, 7th Block,<br /> Jayanagar, Bengaluru – 560070, Karnataka</p>
                  </div>
