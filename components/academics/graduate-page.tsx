...
import { ArrowRight, CheckCircle2, BookOpen, Clock, Users, Award, Microscope, Info } from 'lucide-react'
...
export function GraduatePageClient({ courses }: { courses: Course[] }) {
  return (
        ...
        <div className="container-wide">
          ...
          {courses.length > 0 ? (
            ...
            <div className="text-center py-16 bg-white border border-slate-100 rounded-3xl max-w-md mx-auto">
              ...
              <p className="text-slate-400 text-xs">Postgraduate programs will be listed here soon.</p>
            </div>
          )}
        </div>
      </section>
      ...
      <section className="relative section-padding overflow-hidden">
        ...
        <div className="relative container-wide text-center text-white">
          <motion.div {...fadeUp}>
            ...
            <p className="text-slate-300 max-w-2xl mx-auto text-lg bg-[rgb(10,16,26)] mb-8">
