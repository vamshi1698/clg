  ...
  return (
    <div className="bg-white text-academic-950">
      ...
      <section className="section-padding bg-slate-50">
        <div className="container-wide">
          <motion.div {...fadeUp} className="text-center mb-12">
            <span className="text-gold-600 text-xs font-bold uppercase tracking-[0.25em]">Youth Empowerment</span>
            <h2 className="font-display text-4xl font-bold text-academic-950 mt-3">NCC & NSS Units</h2>
            <p className="text-slate-600 text-base mt-3 max-w-2xl mx-auto">Our active NCC and NSS units foster leadership, discipline, community service, and national pride among students.</p>
          </motion.div>
              ...
              <Link href="/campus-life/ncc" className="block group">
                <div className="relative h-64 rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-white">
                    <h3 className="font-display text-2xl font-bold mb-1 group-hover:text-gold-400 transition-colors">National Cadet Corps</h3>
                    <p className="text-slate-300 text-sm">Unity and Discipline — Military training, camps, and leadership</p>
                    <span className="inline-flex items-center gap-1.5 mt-3 text-gold-400 text-sm font-semibold group-hover:gap-2.5 transition-all">
                      Explore NCC <ArrowRight className="w-4 h-4" />
                    </span>
                  </div>
                </div>
              </Link>
            ...
            <motion.div {...fadeUp} transition={{ duration: 0.6, delay: 0.15 }}>
              <Link href="/campus-life/nss" className="block group">
                <div className="relative h-64 rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-academic-950/70 to-transparent" />
                  <div className="absolute bottom-6 left-6 right-6 text-white">
                    <h3 className="font-display text-2xl font-bold mb-1 group-hover:text-gold-400 transition-colors">National Service Scheme</h3>
                    <p className="text-slate-300 text-sm">Not Me But You — Community service, camps, and social impact</p>
                    <span className="inline-flex items-center gap-1.5 mt-3 text-gold-400 text-sm font-semibold group-hover:gap-2.5 transition-all">
                      Explore NSS <ArrowRight className="w-4 h-4" />
                    </span>
                  </div>
                </div>
              </Link>
